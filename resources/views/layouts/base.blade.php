				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="index.html" class="link-to-home"><img src="" alt=""></a>
						</div>
									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">5th Avenue NewYork ,NYC United States</p>
											</li>
											<li>
												<i class="fa fa-phone" aria-hidden="true"></i>
												<p class="contact-txt">(+123) 456 789 - (+123) 555 5555</p>
											</li>
											<li>
												<i class="fa fa-envelope" aria-hidden="true"></i>
												<p class="contact-txt">ibrahimkhalaf99@gmail.com</p>
											</li>
										</ul>
									</div>
								</div>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-hotline-footer">
										...
										<b class="phone-number">(+123) 456 789 - (+123) 555 5555 </b>
									</div>
								</div>
							</div>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2021 Ibm. All rights reserved</p>
					</div>
...
{{--<script src="{{asset('assets/js/chosen.jquery.min.js')}}"></script>--}}
    ...
    <script src="https://cdn.tiny.cloud/1/x3vi8nno51zybqjar4yatgcyvbgv8gc4x1hzahke9qz1d7l5/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
